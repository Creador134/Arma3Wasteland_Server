...
_setupObjects =
{
	...
	_randomBox = selectRandom ["mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers","airdrop_DLC_LMGs","airdrop_DLC_Rifles"];
	...
	_randomBox2 = selectRandom ["mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers","airdrop_DLC_LMGs","airdrop_DLC_Rifles"];
