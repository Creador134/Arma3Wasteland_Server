	...
	switch (true) do
	{
		case (!isNull _displayPaint): //Paint panel
		{
			...
			switch (lbCurSel _Paint_select) do
			{
				...
				{
					closeDialog 0;					
					[18] execVM "addons\Painter\UniformPainter.sqf";
				};
				case 19:
				{
					closeDialog 0;					
					[19] execVM "addons\Painter\UniformPainter.sqf";
				};
				case 20:
				{
					closeDialog 0;					
					[20] execVM "addons\Painter\UniformPainter.sqf";
				};
				case 21:
				{
					closeDialog 0;					
					[21] execVM "addons\Painter\UniformPainter.sqf";
				};
			};
		};
	};
