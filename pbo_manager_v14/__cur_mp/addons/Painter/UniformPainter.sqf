...
if (_paint == 0) then {
player setObjectTextureGlobal  [0, _texDir + "nato.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "nato.paa"];
};
	
if (_paint == 1) then {
player setObjectTextureGlobal  [0, _texDir + "csat.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "csat.paa"];
};

if (_paint == 2) then {
player setObjectTextureGlobal  [0, _texDir + "aaf.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "aaf.paa"];
};
...
if (_paint == 19) then {
player setObjectTextureGlobal  [0, _texDir + "murica.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "murica.paa"];
};
...
if (_paint == 21) then {
player setObjectTextureGlobal  [0, _texDir + "isis.paa"]; backpackContainer player setObjectTextureGlobal  [0, _texDir + "isis.paa"];
};