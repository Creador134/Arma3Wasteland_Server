...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to SECTOR 9 Wasteland, please wait for your client to initialize", "BLACK", 0.01];
...
if (hasInterface || isServer) then
{
	...
	[] execVM "addons\ToxicGasGrenades\initGrenades.sqf";
	[] execVM "addons\playerJump\playerJump.sqf";
