...
_serverInfoString = format ["<t color='#A0FFFF'>Team Core | A3Wasteland Stratis</t>"];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://a3teamcore.blogspot.com.br/'>Team Core</a></t>";
