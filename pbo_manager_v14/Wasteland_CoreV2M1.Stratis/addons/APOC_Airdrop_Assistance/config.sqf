...
//Also, presently, these are NON-Persistant vehicles.  Meaning that they will not last over a restart.  Keep that in mind with prices.  Later updates I'll set that up, with pin code entry.
	["Vehicles Armed",
		[
			...
			["Prowler HMG",			"B_T_LSV_01_armed_F",				18000,		"vehicle"],
			["Qilin Minigun",		"O_T_LSV_02_armed_F",				18000,		"vehicle"]
	...
	["Vehicles Unarmed",
		[
		    ["Quadbike (Civilian)", "C_Quadbike_01_F",                  1600,        "vehicle"],
			["Strider",				"I_MRAP_03_F",						10000,		"vehicle"],
			["Ifrit",				"O_MRAP_02_F",						10000,		"vehicle"],
			["Offroad Police",		"B_GEN_Offroad_01_gen_F",			5000,		"vehicle"],
			["Prowler",				"B_T_LSV_01_unarmed_F",				7000,		"vehicle"],
			["Qilin",				"O_T_LSV_02_unarmed_F",				7000,		"vehicle"],
	...
	["Boats Armed",
		[
			["Speedboat Minigun",	"I_Boat_Armed_01_minigun_F",		9500,		"vehicle"],
			["Speedboat HMG", 		"O_Boat_Armed_01_hmg_F",			10000,		"vehicle"]
		]
	],
	...
	["Weapons",
		[
			...
			["DLC Rifles",			"airdrop_DLC_Rifles",				55000,		"supply"],
			["DLC LMGs",			"airdrop_DLC_LMGs",					60000,		"supply"],
			["Launchers",			"airdrop_USLaunchers",				85000,		"supply"],
			["Divers",				"airdrop_Divers",					30000,		"supply"],
