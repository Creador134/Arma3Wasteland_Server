...
switch (true) do
{
	...
	case (_objClass isKindOf "ReammoBox_F"):
	{
		...
		_obj addMagazineCargoGlobal ["SmokeShell", 4];
		_obj addMagazineCargoGlobal ["11Rnd_45ACP_Mag", 4];
		_obj addMagazineCargoGlobal ["30Rnd_65x39_caseless_mag", 4];
		_obj addMagazineCargoGlobal ["20Rnd_762x51_Mag", 4];
		_obj addMagazineCargoGlobal ["9Rnd_45ACP_Mag", 4];
		_obj addMagazineCargoGlobal ["30Rnd_65x39_caseless_green", 4];
