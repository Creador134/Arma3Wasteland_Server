...
[
	...
	["<t color='#FF00FF'>Open magic parachute</t>", A3W_fnc_openParachute, [], 20, true, true, "", "vehicle player == player && (getPos player) select 2 > 10 && !(player getVariable ['AR_Is_Rappelling', false]) && !(player getVariable ['AUR_Is_Rappelling', false])"],
