...
#define ERR_NOT_ENOUGH_FUNDS "Você há dinheiro suficiente em sua conta."
#define ERR_INVALID_ACCOUNT "A conta selecionada é invalida."
#define ERR_MIN_START_BOUNTY "O valor mónimo para o bounty é $%1.\nVocê precisará gastar $%2 para começar o bounty."
#define ERR_MAX_BOUNTY "A conta selecionada atingiu o máximo de bounty.\nVocê não pode adicionar mais $%1 neste bounty."

#define MSG_CONFIRM_LINE1 "Você está prestes a adicionar um bounty com recompensa de $%1 para %2."
#define MSG_CONFIRM_LINE2 "Custo: $%1"
...
_maxBounty = ["A3W_bountyMax", 300000] call getPublicVar;
