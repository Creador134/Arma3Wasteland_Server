...
class AtmGUI
{
	...
	class AtmBountyCheckbox
	{
	  idc = AtmBountyCheckbox_IDC;
		...
		style = 0;
		checked = 0;
		tooltip = "Coloque um Bounty na cabeça de um inimigo.\nO Bounty recompensará o assassino desse alvo.\nNÃO é permitido por o Bounty em si\ntrabalhar em conjunto ou juntar-se ao mesmo grupo.\nNÃO haverá recompensa se o próprio alvo do Bounty se matar";
		color[] = {1, 1, 1, 0.7};
