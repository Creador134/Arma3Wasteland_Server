...
class playerSettings {
	...
	class controlsBackground {
		...
		class ccgsub1: w_RscText
		{
			idc = -1;
			text = "Olympus Server"; //--- ToDo: Localize;
			sizeEx = 0.04;
			shadow = 2;			
			x = 0.6375;
			y = 0.14;
	...
	class controls {
		...
		{
			idc = -1;
			text = "Pintura uniforme"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			text = "Repintar Veículos"; //--- ToDo: Localize;
