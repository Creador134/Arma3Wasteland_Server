...
storePurchaseHandle = _this spawn
{
	...
	{
		_itemText = _this select 0;
		hint parseText format ["<t color='#ffff00'>Este item so pode ser pego<br/>completando uma missão.</t><br/>Procure missões no mapa<br/>para poder coleta-lo.", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
