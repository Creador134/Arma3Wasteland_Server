...
private _levelEnabled = ["A3W_levelEnabled"] call isConfigOn;
...
if (_levelEnabled) then
{
	_result = ["getPlayerPlayerLevel:" + _UID, 2] call extDB_Database_async;
	
	_playerLevel = _result param [0,0];
};
